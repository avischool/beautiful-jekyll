...
I worked next to Sarene and Zach in the classroom, but I don't believe any of my code was through collaboration with them. I also used Mr. Lee for support.

In general, I think I learned that before diving in and writing code, I need to take a step back and think about what I have to do. For the third question, at first I didn't try to make a table, or write pseudocode, or do anything else that would involve understanding the question, and this really impacted my ability to think when I was trying different ideas out. In the future I am going to make sure I know what I want to do and how I'm going to do it before I start typing.
